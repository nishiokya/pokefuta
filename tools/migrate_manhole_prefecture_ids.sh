...
# Migration Helper: Populate prefecture_id and prefecture_code for existing manhole data
# このスクリプトは、既存のマンホールデータに prefecture_id と prefecture_code を埋める
# マイグレーション 006 実行後に使用してください

# 使用方法:
#   chmod +x tools/migrate_manhole_prefecture_ids.sh
#   ./tools/migrate_manhole_prefecture_ids.sh
#
# または psql で直接実行:
...
cat << 'EOF'
-- ========================================
-- Helper: Populate prefecture_id and prefecture_code
-- ========================================
