 ...
 *
 * 下タブ（SP）と PC ヘッダーは layout から常時描画され、`探す`(/nearby) と
 * `スタンプ帳`(/visits) を、ログイン時はさらに `マイ旅`(/my-trip) を出す
 * （未ログインは GUEST_NAV_ITEMS なのでマイ旅は出ない）。**このタブと同じ
 * 行き先を Breadcrumb でも出すと、同じリンクが画面に2つ並ぶだけ**になる。
 *
